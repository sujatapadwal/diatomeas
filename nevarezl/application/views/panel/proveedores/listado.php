...
<div id="contentAll" class="f-l">
	<form action="<?php echo base_url('panel/proveedores'); ?>" method="get" class="frmfiltros corner-all8 btn-gray">
...
<?php foreach($proveedores['proveedores'] as $provee){ ?>
		<tr>
			<td><?php echo $provee->nombre; ?></td>
			<td><?php echo $provee->telefono; ?></td>
			<td><?php echo $provee->email; ?></td>
			<td><?php echo $provee->recepcion_facturas; ?></td>
			<td><?php echo $provee->dias_pago; ?></td>
			<td class="tdsmenu a-c" style="width: 90px;">
				<img alt="opc" src="<?php echo base_url('application/images/privilegios/gear.png'); ?>" width="16" height="16">
				<div class="submenul">
					<p class="corner-bottom8">
						<?php 
						echo $this->empleados_model->getLinkPrivSm('proveedores/modificar/', $provee->id_proveedor); 
						echo $this->empleados_model->getLinkPrivSm('proveedores/eliminar/', $provee->id_proveedor, 
								"msb.confirm('Estas seguro de eliminar al proveedor?', this); return false;");
						?>
					</p>
				</div>
			</td>
