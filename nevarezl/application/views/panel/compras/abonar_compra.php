...
<div>
	...
	<form action="<?php echo base_url('panel/compras/pagar?'.String::getVarsLink()); ?>" method="post" class="frm_addmod">
			...
			<p>
				...
				<input type="text" name="dconcepto" id="dconcepto" value="<?php echo set_value('dconcepto'); ?>" size="48" maxlength="120">
			</p>
			
			<p class="w50 f-l">
				<label for="dmonto">*Monto:</label> <br>
				<input type="text" name="dmonto" id="dmonto" value="<?php echo set_value('dmonto', 0); ?>" class="vpositive" size="10" max="92147483647">
			</p>
			<div class="clear"></div>
