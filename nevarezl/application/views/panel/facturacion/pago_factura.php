...
<div>
	...
	<form action="<?php echo  base_url('panel/facturacion/pagar/?'.String::getVarsLink(array('msg')));?>" method="post">
		<div class="frmsec-left w90 f-l">
			...
			<p class="f-r w70">		
				<table class="tblListados corner-all8" style="width:40% !important;margin-right:0px;">
						...
						<tr>
							<td style="text-align:right;">Restante</td>
			...
			<p class="f-l w100">
				...
				<textarea name="fconcepto" rows="4" cols="53" autofocus><?php echo  set_value('fconcepto')!='' ? set_value('fconcepto') : (isset($_GET['tipo'])?"Abono de la Factura ($folio)":"Pago total de la Factura ({$serie}-{$folio})"); ?></textarea>
			</p>
