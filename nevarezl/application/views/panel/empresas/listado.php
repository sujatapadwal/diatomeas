...
<div id="contentAll" class="f-l">
	<form action="<?php echo base_url('panel/empresas'); ?>" method="get" class="frmfiltros corner-all8 btn-gray">
			...
			<td class="tdsmenu a-c" style="width: 90px;">
				...
				<div class="submenul">
					<p class="corner-bottom8">
						<?php 
						echo $this->empleados_model->getLinkPrivSm('empresas/modificar/', $empresa->id_empresa); 
						echo $this->empleados_model->getLinkPrivSm('empresas/eliminar/', $empresa->id_empresa, 
							"msb.confirm('Estas seguro de eliminar?', this); return false;");
						?>
					</p>
				</div>
			</td>
