...
<div id="contentAll" class="f-l">
	<form action="<?php echo base_url('panel/cuentas_pagar'); ?>" method="get" class="frmfiltros corner-all8 btn-gray">
...
?>
		<tr>
			<td><a href="<?php echo base_url('panel/cuentas_pagar/cuenta_proveedor').'?id_proveedor='.$cuenta->id_proveedor.'&'.
				String::getVarsLink(array('id_proveedor')); ?>" class="linksm lkzoom"><?php echo $cuenta->nombre; ?></a></td>
