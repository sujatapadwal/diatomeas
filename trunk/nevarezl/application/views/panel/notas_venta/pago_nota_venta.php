...
<div>
	...
	<form action="<?php echo  base_url('panel/notas_venta/pagar/?'.String::getVarsLink(array('msg')));?>" method="post">
		<div class="frmsec-left w90 f-l">
			...
			<p class="f-l w100">
				...
				<textarea name="fconcepto" rows="4" cols="53" autofocus><?php echo  set_value('fconcepto')!='' ? set_value('fconcepto') : "Pago total de la venta ({$folio})" ; ?></textarea>
			</p>
