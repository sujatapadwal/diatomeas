...
<div>
	...
	<form action="<?php echo base_url('panel/productos/modificar_familia/?'.String::getVarsLink(array('msg'))); ?>" method="post" class="form-horizontal">
	  <fieldset>
			<legend></legend>
			...
			<div class="span12">
				<div class="control-group">
				  ...
				  <div class="controls">
						<input type="text" name="dcodigo" id="dcodigo" class="span6" size="5" maxlength="8"
							value="<?php echo (isset($info_familia[0]->codigo)? $info_familia[0]->codigo: ''); ?>" autofocus required>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
						<input type="text" name="dnombre" id="dnombre" class="span6" 
							value="<?php echo (isset($info_familia[0]->nombre)? $info_familia[0]->nombre: ''); ?>" size="40" maxlength="60" required>
				  </div>
				</div>
