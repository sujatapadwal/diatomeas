...
<div>
	...
	<form action="<?php echo base_url('panel/productos/modificar/?'.String::getVarsLink(array('msg', 'familia'))); ?>" method="post" class="form-horizontal">
	  <fieldset>
			<legend></legend>
			...
			<div class="span12">
				<div class="control-group">
				  ...
				  <div class="controls">
						<input type="text" name="dcodigo" id="dcodigo" class="span6" value="<?php echo (isset($producto['info']->codigo)? $producto['info']->codigo: ''); ?>" maxlength="8" autofocus required>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
				  	<input type="text" name="dnombre" id="dnombre" class="span6" value="<?php echo (isset($producto['info']->nombre)? $producto['info']->nombre: ''); ?>" maxlength="70" required>
				  </div>
				</div>
